//Thanks to NicxEU#7227 for the leak hehe if there are any invisible menus there is a 99.999999% chance thats its this but fuck  it
//Side note Spectre#5658 your a fucking retarded skid goodluck "Cracking my shit"
//Virus Aim on top
//Juice Aim on top
...
void main()
{
	...
	{
		printf(_xor_("You need to load Driver first! (Closing!)\n").c_str());
		Sleep(2000);
		exit(0);
	}
